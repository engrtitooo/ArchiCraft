...
export const Header: React.FC<HeaderProps> = ({ onNavigate, onLogoClick }) => {
  return (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center gap-4">
             <a href="https://github.com/engrtitooo/ArchiCraft" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-gray-900 transition-colors" title="View on GitHub">
             ...
             <span className="text-xs font-mono text-gray-400 border-l border-gray-200 pl-4">v1.0.0</span>
          </div>
        </div>
      </div>
    </header>
